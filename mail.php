...
if(isset($_POST['demo-email'])) {
    ...
    $email_to = "kattamuri.meghna@gmail.com";
    ...
    $first_name = $_POST['demo-name']; // required
    $email_from = $_POST['demo-email']; // required
    $comments = $_POST['demo-message']; // required
...
$mail->addAddress('kattamuri.meghna@gmail.com', 'My Friend');
